...
MC = r.TChain("ntuple")
MC.Add('/afs/cern.ch/user/x/xuqin/cernbox/workdir/B0KstMuMu/reweight/Tree/final/XGBV4/{}_MC_JPSI_scale_and_preselection_forreweighting_p{}.root'.format(year,parity))
...
plt.legend(loc='best')
plt.tight_layout()
plt.savefig('plots/eta{}_subsample{}_depth{}_round{}/loss_score_v4.pdf'.format(eta,subsample,max_depth,num_round))
...
plt.tight_layout()
#plt.show()
plt.savefig('plots/eta{}_subsample{}_depth{}_round{}/fscore_v4.pdf'.format(eta,subsample,max_depth,num_round))
...
# plt.tight_layout()
plt.savefig('plots/eta{}_subsample{}_depth{}_round{}/overtrain_v4.pdf'.format(eta,subsample,max_depth,num_round))
...
plt.savefig('plots/eta{}_subsample{}_depth{}_round{}/ROC_v4.pdf'.format(eta,subsample,max_depth,num_round))


Save_Dir = './model/{}_XGBV4_eta{}_subsample{}_depth{}_round{}.json'.format(year,eta,subsample,max_depth,num_round)
