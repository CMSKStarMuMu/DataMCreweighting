...
def plot_var(varname, cut="1", reweight=False):
    ...
    rdata.SetBranchStatus("nsigb{}p1_{}_sw".format(q2Bin,year), 1) #this ensure the introduction of SWeight of real data for signal extraction from background
    if reweight: 
    ...
    swname = "nsigb{}p1_{}_sw*".format(q2Bin,year)
