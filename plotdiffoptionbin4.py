...
columns_draw = [
                "bPt","bEta","bVtxCL","bDCABS","bDCABSE","bLBS","bLBSE",
                "mumPt","mumEta","mumPhi",
                "mupPt","mupEta","mupPhi",
...
rdata.Add("/afs/cern.ch/user/x/xuqin/cernbox/workdir/B0KstMuMu/reweight/Tree/final/XGBV4/recoDATADataset_b4_2018_p1_aftersel.root")
rMC_ori.Add("/afs/cern.ch/user/x/xuqin/cernbox/workdir/B0KstMuMu/reweight/Tree/final/XGBV4/2018_MC_JPSI_scale_and_preselection_XGBV4_p1.root")
rMC_rw.Add("/afs/cern.ch/user/x/xuqin/cernbox/workdir/B0KstMuMu/reweight/Tree/final/XGBV4/2018_MC_JPSI_scale_and_preselection_XGBV4_p1.root")
...
def plot_var(varname):
    ...
    for i in range(0,2):
        ...
        if i==0:
            rMC[i].Draw('{}>>h{}_MC_{}'.format(varname,varname,label[i]),'weight*({})'.format(selMC+selBmass),'goff')
        else:
            rMC[i].Draw('{}>>h{}_MC_{}'.format(varname,varname,label[i]),'weight*MCw*({})'.format(selMC+selBmass),'goff')
    ...
    c.SaveAs('Complots/bin4/{}.png'.format(varname))
