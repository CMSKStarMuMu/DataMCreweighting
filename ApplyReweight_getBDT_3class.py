...
if data1==1:
    MCwFile = r.TFile("./files/2016/JPsiKdata_BDTout_XGBV7_{}_3class.root".format(year),"RECREATE")
    ...
    MCwFile = r.TFile("./files/2016/JPsiKMC_BDTout_XGBV7_{}_3class.root".format(year),"RECREATE")
